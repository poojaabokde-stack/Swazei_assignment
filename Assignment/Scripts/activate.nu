...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'D:\pythonProject\TestAutomation_assignment.docx'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'D:\pythonProject\TestAutomation_assignment.docx\Scripts\deactivate.nu'
